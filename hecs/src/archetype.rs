...
pub struct TypeInfo {
    ...
    pub id: TypeId,
    /// The [`Layout`] needed to allocate or deallocate components of this type.
    pub layout: Layout,
    /// The type-erased destructor for this component type.
    pub drop: unsafe fn(*mut u8),
    #[cfg(debug_assertions)]
    /// The string name of the type, for debug use.
...
impl TypeInfo {
    ...
    /// [`TypeId`] component of this `TypeInfo`
