...
pub struct TypeInfo {
    ...
    pub id: TypeId,
    /// The component's [`Layout`], for allocation/deallocation.
    pub layout: Layout,
    /// The component's type-erased in-place destructor.
    pub drop: unsafe fn(*mut u8),
    #[cfg(debug_assertions)]
    /// The string name of the type as presented by [`core::any::type_name`].
